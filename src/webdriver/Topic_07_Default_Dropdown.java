...
// Chỗ này ko dùng @Test nhé (vì nó là Class)
public class Topic_07_Default_Dropdown {
	...
	public void TC_03_Default_Dropdown() {
		...
		// So sanh Web Element - String -> Nên phải có hàm getText, get text trả về
		// String
	...
	public void TC_04_Default_Dropdown() {
		// Bài này cần handle Popup nữa em nha - họ mới change business
