...
public class Topic_14_Javascript_Executer {
	...
	public void beforeClass() {
		...
		// Vs 1 interface: add kiểu của driver qua jsExecutor, interface k dùng khởi
		// tạo, k có new
	...
	public void TC_01_TechPanda() {
		/*
		 * Note: Các đoạn Javascript vào ts chạy rất nhanh Khi chuyển trang (navigate và
		 * click) trên các browser nó sẽ k chờ các element đc ready trc khi thao tác ->
		 * Nên có time sleep
		 */
		...
		hightlightElement(
				"//a[text()='Samsung Galaxy']/parent::h2/following-sibling::div/button[@title='Add to Cart']");
		clickToElementByJS(
				"//a[text()='Samsung Galaxy']/parent::h2/following-sibling::div/button[@title='Add to Cart']");
		sleepInSecond(3);
